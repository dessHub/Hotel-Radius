...
$SQL = $con->prepare("INSERT INTO tbl_prof(image,userName) VALUES(?,?)");
...
//  $sql = $conn->prepare("UPDATE tbl_prof SET image, companyName=? WHERE id=?");
//  $sql->bind_param("ssi",$image,$company,$_GET['edit']);
//  $sql->execute();
...
echo "<div class='alert alert-success'>
        ...
        <strong>Success!</strong>.Profile Pic Uploaded</div>";
}
}
else
{
